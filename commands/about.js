		...
		const riiInfo = new Discord.RichEmbed()
			...
			.setDescription(
				"6. 2. 2019\nRunning on Discord.js@11.4.2!\n\n**Use " +
					process.env.PREFIX +
					"help to check the available commands.**\nhttps://github.com/Matojeje/mato-bot\nLicense: MIT"
			)
			.addField(
				"Uptime",
				Math.round(client.uptime) +
					...
					client.readyAt
						.toString()
						.replace("00 (Střední Evropa (běžný čas))", "")
						.replace("GMT+0", "GMT+")
						.replace("GMT-0", "GMT-") +
					"*",
				true
			...
			.setFooter(
				"By Mato",
				"https://cdn.discordapp.com/avatars/334780937135194112/07e19132e1f110b9dc8aa82b80d09a5a.png"
			);
